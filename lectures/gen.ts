...
export const LECTURE_SPECS = [
  ...
  { spec: LECTURE_14, updated: false, deadline: DateTime.fromISO("2024-03-06", {zone: "America/Detroit"}).plus({days: 2, hours: 23, minutes: 59, seconds: 59}) },
  ...
  { spec: LECTURE_20, updated: false, deadline: DateTime.fromISO("2024-04-01", {zone: "America/Detroit"}).plus({days: 2, hours: 23, minutes: 59, seconds: 59}) },
