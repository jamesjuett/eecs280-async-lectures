...
export const LECTURE_19 = Exam.create({
  exam_id: "lec_19_structural_recursion",
  ...
  sections: [
    {
      ...
      questions: [
        {
          question_id: "lec19_recursive_list_functions",
    ...
    },
    {
      ...
      questions: [
        {
          question_id: "lec19_recursive_tree_functions",
