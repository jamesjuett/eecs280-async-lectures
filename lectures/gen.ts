...
export const LECTURE_SPECS = [
  ...
  { spec: CONST_STRUCTS_AND_C_STYLE_ADTS           , id: "f26_lec_06"            , deadline: DateTime.fromISO("2026-09-21", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  { spec: CONST_STRUCTS_AND_C_STYLE_ADTS           , id: "f26_lec_06_transfer"   , deadline: DateTime.fromISO("2026-09-21", {zone: "America/Detroit"}).plus({hours: 12, minutes: 0, seconds: 0}) },
  { spec: STREAMS_AND_IO                           , id: "f26_lec_07"            , deadline: DateTime.fromISO("2026-09-23", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  { spec: STREAMS_AND_IO                           , id: "f26_lec_07_transfer"   , deadline: DateTime.fromISO("2026-09-23", {zone: "America/Detroit"}).plus({hours: 12, minutes: 0, seconds: 0}) },
  ...
  // { spec: ADTS_IN_CPP                                           , deadline: DateTime.fromISO("2025-09-22", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  // { spec: OPERATOR_OVERLOADING_AND_INHERITANCE                  , deadline: DateTime.fromISO("2025-09-24", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  // { spec: POLYMORPHISM                                          , deadline: DateTime.fromISO("2025-09-29", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  // { spec: ARRAYS_POINTER_ARITHMETIC_C_STRINGS                   , deadline: DateTime.fromISO("2025-10-01", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  // { spec: ARRAY_BASED_DATA_STRUCTURES                           , deadline: DateTime.fromISO("2025-10-06", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  // { spec: SORTED_VS_UNSORTED_DATA_STRUCTURES                    , deadline: DateTime.fromISO("2025-10-08", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  // { spec: CONTAINERS_AND_ITERATORS                              , deadline: DateTime.fromISO("2025-10-15", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  // { spec: DYNAMIC_MEMORY                                        , deadline: DateTime.fromISO("2025-10-20", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  // { spec: RAII_AND_GROWABLE_CONTAINERS                          , deadline: DateTime.fromISO("2025-10-22", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  // { spec: DEEP_COPIES_AND_THE_BIG_THREE                         , deadline: DateTime.fromISO("2025-10-29", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  // { spec: LINKED_LISTS                                          , deadline: DateTime.fromISO("2025-11-03", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  // { spec: LINKED_LIST_ITERATORS                                 , deadline: DateTime.fromISO("2025-11-05", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  // { spec: FUNCTORS_AND_IMPOSTOR_SYNDROME                        , deadline: DateTime.fromISO("2025-11-10", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  // { spec: RECURSION                                             , deadline: DateTime.fromISO("2025-11-12", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  // { spec: STRUCTURAL_RECURSION                                  , deadline: DateTime.fromISO("2025-11-17", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  // { spec: BINARY_SEARCH_TREES                                   , deadline: DateTime.fromISO("2025-11-19", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  // { spec: EXCEPTIONS                                            , deadline: DateTime.fromISO("2025-11-24", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
].map((lec, i) => {
