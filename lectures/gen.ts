...
export const LECTURE_SPECS = [
  { spec: INTRO                                                 , updated: true, deadline: DateTime.fromISO("2025-05-06", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  { spec: TYPES_CONTROL_STRUCTURES_AND_PROCEDURAL_ABSTRACTION   , updated: true, deadline: DateTime.fromISO("2025-05-07", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  { spec: MACHINE_MODEL_PART_1                                  , updated: true, deadline: DateTime.fromISO("2025-05-08", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  { spec: MACHINE_MODEL_PART_2                                  , updated: true, deadline: DateTime.fromISO("2025-05-12", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  // { spec: CONST_STRUCTS_AND_C_STYLE_ADTS                        , updated: true, deadline: DateTime.fromISO("2025-05-13", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  // { spec: STREAMS_AND_IO                                        , updated: true, deadline: DateTime.fromISO("2025-05-14", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  // { spec: PROGRAM_DESIGN_AND_DEBUGGING                          , updated: true, deadline: DateTime.fromISO("2025-05-15", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  // { spec: ADTS_IN_CPP                                           , updated: true, deadline: DateTime.fromISO("2025-05-19", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  // { spec: OPERATOR_OVERLOADING_AND_INHERITANCE                  , updated: true, deadline: DateTime.fromISO("2025-05-20", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  // { spec: POLYMORPHISM                                          , updated: true, deadline: DateTime.fromISO("2025-05-21", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  // { spec: ARRAYS_POINTER_ARITHMETIC_C_STRINGS                   , updated: true, deadline: DateTime.fromISO("2025-05-22", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  // { spec: ARRAY_BASED_DATA_STRUCTURES                           , updated: true, deadline: DateTime.fromISO("2025-05-27", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  // { spec: SORTED_VS_UNSORTED_DATA_STRUCTURES                    , updated: true, deadline: DateTime.fromISO("2025-05-28", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  ...
  // { spec: STRUCTURAL_RECURSION                                  , updated: true, deadline: DateTime.fromISO("2025-06-16", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  // { spec: BINARY_SEARCH_TREES                                   , updated: true, deadline: DateTime.fromISO("2025-06-17", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  // { spec: EXCEPTIONS                                            , updated: true, deadline: DateTime.fromISO("2025-06-18", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
].map((lec, i) => {
  let spec = CUSTOMIZE(lec.spec, {
    ...
    exam_id: `sp25_lec_${String(i + 1).padStart(2, "0")}`,
