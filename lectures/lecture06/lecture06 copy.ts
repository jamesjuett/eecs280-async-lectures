...
export const LECTURE_06 : ExamSpecification = {
  ...
  mk_intructions: dedent`
    ...
    <div markdown=1 class="alert alert-info">
      TODO
      This lecture is all about input and output (I/O). This can take many forms:
      - Standard input and output streams,
      
      TODO
      Fundamentally, these all involve processing text data represented as sequences of characters - perhaps the text of a book, an encrypted message, or even the source code for one of our programs as it's about to be digested by the compiler!
    </div>
    <style>
      .lec-video {
        width: 80%;
