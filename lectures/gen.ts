...
export const LECTURE_SPECS = [
  ...
  { spec: MACHINE_MODEL_PART_1                     , id: "f26_lec_04"            , deadline: DateTime.fromISO("2026-09-04", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  { spec: MACHINE_MODEL_PART_1                     , id: "f26_lec_04_transfer"   , deadline: DateTime.fromISO("2026-09-04", {zone: "America/Detroit"}).plus({hours: 12, minutes: 0, seconds: 0}) },
  ...
  // { spec: CONST_STRUCTS_AND_C_STYLE_ADTS                        , deadline: DateTime.fromISO("2025-09-15", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
  // { spec: STREAMS_AND_IO                                        , deadline: DateTime.fromISO("2025-09-17", {zone: "America/Detroit"}).plus({hours: 23, minutes: 59, seconds: 59}) },
