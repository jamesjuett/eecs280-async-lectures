...
export const MACHINE_MODEL_PART_2 : Omit<ExamSpecification, "exam_id"> = {
  ...
  mk_intructions: dedent`
    ...
    <div markdown=1 class="alert alert-info">
      This is part two of our exploration of the underlying machine model. A primary focus will be on the way local objects and their underlying memory are managed by the **function call stack**. We'll also cover different mechanisms for **parameter passing and returned results** from functions.
