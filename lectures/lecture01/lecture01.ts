  ...
  sections: [
    ...
    },
    {
      ...
      mk_description: dedent`
        ...
        **Computer/C++ Setup Walkthrough Sessions**  
        ...
        - Time TBD, likely Tuesday or Wednesday evening via Zoom. Check eecs280.org for updates and Zoom links.
    ...
    },
    {
      ...
      mk_description: dedent`
        ...
        <div class="alert alert-secondary" role="alert" markdown="1">
          <h5><span class="badge badge-primary">Fall 2026</span></h5>
          One quick difference for this term from the video above: labs are worth 10% of the overall grade, with projects 2-5 each worth 1% less.
        </div>
    ...
    },
    {
      ...
      mk_description: dedent`
        ...
        <div class="alert alert-secondary" role="alert" markdown="1">
          <h5><span class="badge badge-primary">Fall 2026</span></h5>
          We're still working on a few potential changes to labs for this term, so there may be a few minor differences from the video above. For example, we may form groups differently or the way you turn in lab work may be different. We'll let you know in lab.
        </div>
      `,
      questions: [ ]
    },
    ...
    },
    {
      ...
      mk_description: dedent`
        ...
        Now, we'll spend some time on a brief, whirlwind-style tour of some C++ fundamentals. This is just a high-level overview, and we'll spend more time on a lot of details throughout the rest of the course.
